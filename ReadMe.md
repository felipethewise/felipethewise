# 💫 About Me:
 Backend and web development begginer.<br> Graduando em Análise e Desenvolvimento de Sistemas.<br><br> *"Estudo backend e desenvolvimento web em geral. Java, JavaScript, NodeJS, Python, API, Machine Learning e etc. Estou à procura de estágio para desenvolver meu aprendizado. Qualquer ajuda será bem-vinda!"*
